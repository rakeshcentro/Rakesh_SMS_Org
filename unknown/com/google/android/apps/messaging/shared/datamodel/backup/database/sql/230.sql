...
CREATE TABLE extensions_backup (extension_id TEXT PRIMARY KEY NOT NULL, package_name TEXT NOT NULL, name TEXT NOT NULL, activation_uri TEXT NOT NULL);
CREATE INDEX index_extensions_backup_extension_id ON extensions_backup(extension_id);
