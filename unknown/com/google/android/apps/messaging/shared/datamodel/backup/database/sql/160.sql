...
CREATE TABLE my_identities_backup (token TEXT PRIMARY KEY NOT NULL, address_type INT, phone_number TEXT, display_name TEXT, canonical_token TEXT REFERENCES my_identities_backup(token) ON DELETE NO ACTION ON UPDATE CASCADE, provisioning_id TEXT, is_verified INT);
